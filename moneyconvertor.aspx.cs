...
public partial class moneyconvertor : System.Web.UI.Page
{
    ...
    protected void Bthistorym_Click(object sender, EventArgs e)
    {
        Response.Redirect("moneyhistory.aspx");
    }
    ...
    protected void Btsavem_Click(object sender, EventArgs e)
    {
        cv.getmoney("insert into moneyconvert values ('" + Txtboxfilename.Text + "','" + FromDDbox.SelectedValue + "','" + ToDDbox.SelectedValue + "','" + FromtextBox.Text + "','" + toTextBox.Text + "')");
    ...
    protected void Txtboxfilename_TextChanged(object sender, EventArgs e)
    {
    ...
    protected void ToDDbox_SelectedIndexChanged(object sender, EventArgs e)
    {
